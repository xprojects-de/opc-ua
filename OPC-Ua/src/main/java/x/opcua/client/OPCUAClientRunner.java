...
public class OPCUAClientRunner {
  ...
  private final OPCUAClientInterface clientExample;
  private final boolean serverRequired;

  public OPCUAClientRunner(OPCUAClientInterface clientExample) throws Exception {
    this(clientExample, true);
  }

  public OPCUAClientRunner(OPCUAClientInterface clientExample, boolean serverRequired) throws Exception {
